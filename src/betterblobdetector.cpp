...
BetterBlobDetector::BetterBlobDetector(const SimpleBlobDetector::Params &parameters) : params(parameters)
{

}

Ptr<BetterBlobDetector> BetterBlobDetector::create(const SimpleBlobDetector::Params& params)
{
    return makePtr<BetterBlobDetector>(params);
}
...
void BetterBlobDetector::detect(const cv::Mat& image, std::vector<cv::KeyPoint>& keypoints, const cv::Mat&) const
{
     _contours.clear();
